		...
		module = starlark.StringDict{
			ModuleName: &starlarkstruct.Module{
				...
				Members: starlark.StringDict{
					...
					"PNG":  starlark.NewBuiltin("PNG", newPNG),
...
func newPNG(
	...
	if err := starlark.UnpackArgs(
		...
		return nil, fmt.Errorf("unpacking arguments for PNG: %s", err)
	}
	...
	w.size = starlark.NewBuiltin("size", pngSize)
...
func (w *PNG) String() string       { return "PNG(...)" }
func (w *PNG) Type() string         { return "PNG" }
func (w *PNG) Freeze()              {}
func (w *PNG) Truth() starlark.Bool { return true }
